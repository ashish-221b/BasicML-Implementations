...
class SVM:
	...
	def update_b(self,diff1,diff2,i1,i2):
		b1 = self.E[i1] + self.Ydata[i1]*diff1*np.dot(self.Xdata[i1],self.Xdata[i1])+self.Ydata[i2]*diff2*np.dot(self.Xdata[i1],self.Xdata[i2])+self.b
		b2 = self.E[i2] + self.Ydata[i1]*diff1*np.dot(self.Xdata[i2],self.Xdata[i1])+self.Ydata[i2]*diff2*np.dot(self.Xdata[i2],self.Xdata[i2])+self.b
